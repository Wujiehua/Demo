<template>
    <div class="shop-header" @click="onheader">
        <nav class="shop-nav">
            <a class="back">
...
<div class="brief-modal-content" style="display:none">
<h2 class="content-title">
<span class="content-tag">
<span class="mini-tag">品牌</span>
</span>
...
<div class="brief-modal-cover" style="display: none"></div>
</div>
<div class="activity-sheet" v-show="headerdiscounts">
...
<script>
    export default {
        data () {
            return {
                headerdiscounts:false
            }
        },
        methods:{
            onheader () {
                console.log('123')
                this.headerdiscounts = !this.headerdiscounts
            }
        }
    }
</script>
